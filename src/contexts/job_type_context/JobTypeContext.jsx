...
//     try {
//       const response = await axios.get("http://localhost:3000/getJobTypes");
...
//     try {
//       const response = await axios.get("http://localhost:3000/getAllJobTypesHaveIDandTypeName");
...
//   return (
//     <JobTypeContext.Provider value={{ jobTypesList, refreshJobTypes: fetchJobTypes, jobTypesIDandNameList, refreshJobTypesIDandName: fetchJobTypesHaveIDandTypeName }}>
//       {children}
