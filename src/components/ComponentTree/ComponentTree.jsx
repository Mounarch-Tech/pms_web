...
// 
const ComponentTree = ({ node, isCheckBoxActive, isReadOnlyView, isAddNewButtonActive, isEditButtonActive, selectedShipID }) => {
    ...
    useEffect(() => {
        // console.log('Component Tree node : ', node)
    }, [])
    ...
    return (
        <div className="tree-node" key={node.id}>
            ...
            >
                ...
                {(isCheckBoxActive || isReadOnlyView) && (
                    <label
                        style={{
                            display: isCheckBoxActive ? 'inline-flex' : 'none',
                            cursor: 'pointer',
                            alignItems: 'center',
                    ...
                    >
                        ...
                        <input
                            type="checkbox"
                            checked={node.isCheckBoxApplicable ? true : isChecked}
                            disabled={isReadOnlyView || node.isCheckBoxApplicable}
                            onChange={isReadOnlyView ? undefined : handleCheckboxChange}
                ...
                {isAddNewButtonActive && (
                    <span
                        ...
                        onClick={(e) => {
                            ...
                            selectNode(node)
                            // alert('You Clicked On: ' + node.data.label + ' For Edit Component');
                    ...
                    <div className="tree-children">
                        {node.children.map((child) => (
                            <ComponentTree
                                ...
                                isReadOnlyView={isReadOnlyView} // ✅ PASS IT DOWN
...
// Showing components for Ship ID: SHA_0003No components found for this ship